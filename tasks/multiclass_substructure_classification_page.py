...
class TransferLearningModelNew(nn.Module):
    def __init__(self, n_classes):
        ...
        self.transfer_learning_model = timm.create_model(
            CONFIG.MODEL_NAMES[0], pretrained=True, in_chans=1
        )
...
class DenseNet201(nn.Module):
    def __init__(self, n_classes):
        ...
        self.transfer_learning_model = timm.create_model(
            "densenet201", pretrained=True, in_chans=1
        )
...
class MobileVitV2_150(nn.Module):
    def __init__(self, n_classes):
        ...
        self.vit_model = timm.create_model(
            CONFIG.MODEL_NAMES[2], pretrained=True, in_chans=1
        )
